...
module.exports.loop = function () {
 ...
 //   }
    ...
    if (!(name < 0) && name!=undefined) {
        console.log("Spawned new " + creepSpawned + " creep: " + name);
    }
};
